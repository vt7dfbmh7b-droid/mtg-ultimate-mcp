...
export const universalCommanderPipelineInputSchemaV15 = z.object({
  ...
  minimumDistinctLibraryRoutes: z.number().int().min(1).max(6).optional(),
...
function compactPipelineOptions(input: UniversalCommanderPipelineInputV15): CommanderBuildPipelineOptionsV15 {
  return {
    ...
    ...(input.minimumDistinctLibraryRoutes !== undefined ? { minimumDistinctLibraryRoutes: input.minimumDistinctLibraryRoutes } : {}),
