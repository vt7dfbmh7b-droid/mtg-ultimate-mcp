...
| MARVEL-B5-REFINE | scenario-intelligence | pass | `816ba2948c74f865e3a681bcb0589fdf0592ca55` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `816ba2948c74f865e3a681bcb0589fdf0592ca55` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
