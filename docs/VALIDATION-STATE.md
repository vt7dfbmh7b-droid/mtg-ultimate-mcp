...
| MARVEL-B5-REFINE | scenario-intelligence | fail | `556787e7864293ecdbd29a37a5761d80fe8af50e` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `556787e7864293ecdbd29a37a5761d80fe8af50e` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
