...
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | pass | `9c75d8fce791d02169c64e4a3d5357badc892ba9` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | pass | `9c75d8fce791d02169c64e4a3d5357badc892ba9` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | pass | `c91569d14f79b0b0763d0090289035f6f70ef3ab` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
