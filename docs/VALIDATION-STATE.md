...
| INTEL-01-POSITIVE | scenario-intelligence | fail | `78544aa21d519ad406dbb81bf334fc41c3325a57` | no | `test-results/intel01-positive/run-metadata.txt` |
| MARVEL-B5-REFINE | scenario-intelligence | fail | `f105df5a0f05f0ef02d30a8ffc1bf3d68c794cdf` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `30792b1d9a1c9b5740724eedc4f0279335bd0d47` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | pass | `30792b1d9a1c9b5740724eedc4f0279335bd0d47` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | pass | `30792b1d9a1c9b5740724eedc4f0279335bd0d47` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | pass | `30792b1d9a1c9b5740724eedc4f0279335bd0d47` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
