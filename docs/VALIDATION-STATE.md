...
|---|---|---|---|---|---|
| PM-STATE-INTEGRITY | engineering+truth | pass | `28e56160f05509af4b8d6c3d60fc53240a00a4bc` | no | `test-results/project-management/integrity.txt` |
| MARVEL-B5-REFINE | scenario-intelligence | fail | `28e56160f05509af4b8d6c3d60fc53240a00a4bc` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `48a7c3f57c10ce855787cc247e371365e53e8ad6` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | pass | `28e56160f05509af4b8d6c3d60fc53240a00a4bc` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
