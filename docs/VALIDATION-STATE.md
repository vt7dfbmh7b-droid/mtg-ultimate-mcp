...
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | fail | `813d40b0e63bd7694a935f59d3f304aa439ff3ec` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | fail | `813d40b0e63bd7694a935f59d3f304aa439ff3ec` | no | `test-results/precon-generalization/run-metadata.txt` |
| STRATEGY-INFERENCE-GENERALIZATION | engineering+truth | fail | `813d40b0e63bd7694a935f59d3f304aa439ff3ec` | no | `test-results/strategy-inference-generalization/run-metadata.txt` |
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | fail | `813d40b0e63bd7694a935f59d3f304aa439ff3ec` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
