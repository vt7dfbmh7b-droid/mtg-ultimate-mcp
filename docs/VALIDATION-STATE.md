...
|---|---|---|---|---|---|
| PM-STATE-INTEGRITY | engineering+truth | pass | `fe40cde70c111f16019a34cdb70c263aaa503f11` | no | `test-results/project-management/integrity.txt` |
| INTEL-01-POSITIVE | scenario-intelligence | fail | `fe40cde70c111f16019a34cdb70c263aaa503f11` | no | `test-results/intel01-positive/run-metadata.txt` |
