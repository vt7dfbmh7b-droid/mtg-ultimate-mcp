...
| MARVEL-B5-BROAD | scenario-intelligence | fail | `78544aa21d519ad406dbb81bf334fc41c3325a57` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
...
| PRECON-GENERALIZATION | scenario-intelligence | fail | `78544aa21d519ad406dbb81bf334fc41c3325a57` | no | `test-results/precon-generalization/run-metadata.txt` |
