...
|---|---|---|---|---|---|
| PM-STATE-INTEGRITY | engineering+truth | pass | `0fcb150961e36cada70412f24fc7736ebb1e5831` | no | `test-results/project-management/integrity.txt` |
...
| SCIONS-SPELLCRAFT-FF-ONLY | scenario-intelligence | fail | `3f4509083eef7fe1bf1cc74f9c6adee1caeb8d9b` | no | `test-results/scions-spellcraft-ff-only/run-metadata.txt` |
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | fail | `3f4509083eef7fe1bf1cc74f9c6adee1caeb8d9b` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | fail | `3f4509083eef7fe1bf1cc74f9c6adee1caeb8d9b` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | fail | `3f4509083eef7fe1bf1cc74f9c6adee1caeb8d9b` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
