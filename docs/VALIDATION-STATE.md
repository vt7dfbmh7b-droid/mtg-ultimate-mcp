...
| MARVEL-B5-BROAD | scenario-intelligence | pass | `852400390a33afe2266b652ae74d516ea135eb3a` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
...
| PRECON-GENERALIZATION | scenario-intelligence | pass | `8c0527701c891cbe94f4ebc284e64c5a0106b9a1` | no | `test-results/precon-generalization/run-metadata.txt` |
