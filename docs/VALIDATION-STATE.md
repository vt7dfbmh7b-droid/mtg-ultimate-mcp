...
| MARVEL-B5-REFINE | scenario-intelligence | pass | `0a872b11239b3b402ded5424d59e004756ca5acc` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | pass | `0a872b11239b3b402ded5424d59e004756ca5acc` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | pass | `0a872b11239b3b402ded5424d59e004756ca5acc` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | pass | `0a872b11239b3b402ded5424d59e004756ca5acc` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | fail | `0a872b11239b3b402ded5424d59e004756ca5acc` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
