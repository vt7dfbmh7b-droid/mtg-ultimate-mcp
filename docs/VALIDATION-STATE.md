...
| STRATEGY-INFERENCE-GENERALIZATION | engineering+truth | fail | `f3d63d02d5bb6f9baeb537a39f1f4f5e79d7b634` | no | `test-results/strategy-inference-generalization/run-metadata.txt` |
