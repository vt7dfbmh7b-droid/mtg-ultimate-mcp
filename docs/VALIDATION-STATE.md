...
| PRECON-GENERALIZATION | scenario-intelligence | fail | `87ac1147acbcfb88cd4577644657573a5fc3f735` | no | `test-results/precon-generalization/run-metadata.txt` |
| STRATEGY-INFERENCE-GENERALIZATION | engineering+truth | fail | `8c0527701c891cbe94f4ebc284e64c5a0106b9a1` | no | `test-results/strategy-inference-generalization/run-metadata.txt` |
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | fail | `87ac1147acbcfb88cd4577644657573a5fc3f735` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
