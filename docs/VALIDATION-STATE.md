...
|---|---|---|---|---|---|
| PM-STATE-INTEGRITY | engineering+truth | pass | `6311f14d73bf5ec36a08f27ec3bf483a6171a5ac` | no | `test-results/project-management/integrity.txt` |
...
| MARVEL-B5-REFINE | scenario-intelligence | fail | `d0e40cadee555468b9b5574234d1b63b477f8b55` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `d0e40cadee555468b9b5574234d1b63b477f8b55` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
| SCIONS-SPELLCRAFT-FF-ONLY | scenario-intelligence | pass | `53a18a65f51c3c023ccee35c126164729d522dba` | no | `test-results/scions-spellcraft-ff-only/run-metadata.txt` |
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | pass | `53a18a65f51c3c023ccee35c126164729d522dba` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | pass | `53a18a65f51c3c023ccee35c126164729d522dba` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | pass | `53a18a65f51c3c023ccee35c126164729d522dba` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
