...
| MARVEL-B5-REFINE | scenario-intelligence | pass | `7265531610a7012f7940f591c99a2fc6ef3af06e` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `7265531610a7012f7940f591c99a2fc6ef3af06e` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | pass | `7265531610a7012f7940f591c99a2fc6ef3af06e` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | pass | `7265531610a7012f7940f591c99a2fc6ef3af06e` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | pass | `7265531610a7012f7940f591c99a2fc6ef3af06e` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
