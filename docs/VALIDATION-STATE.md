...
| MARVEL-B5-REFINE | scenario-intelligence | fail | `c2ddbb749837d5ea054adfe36c5430b366bc6d96` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | pass | `e94010f4e5ecf967ea20fd2a5d2eb7670f95f691` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
