...
| MARVEL-B5-REFINE | scenario-intelligence | pass | `977b669851cd63903c9b760407a1e2c8f68c2e58` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `977b669851cd63903c9b760407a1e2c8f68c2e58` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
