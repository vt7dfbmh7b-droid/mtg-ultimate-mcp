...
| MARVEL-B5-REFINE | scenario-intelligence | pass | `852400390a33afe2266b652ae74d516ea135eb3a` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
...
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | fail | `456735ae03d5f1e30c59db744493c06690fb9561` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | pass | `456735ae03d5f1e30c59db744493c06690fb9561` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | pass | `456735ae03d5f1e30c59db744493c06690fb9561` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
