...
| MARVEL-B5-REFINE | scenario-intelligence | pass | `38dedb5efb7a3cefc154d56e1eab9599bd7dfa56` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `38dedb5efb7a3cefc154d56e1eab9599bd7dfa56` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
