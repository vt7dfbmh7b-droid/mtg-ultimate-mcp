...
| MARVEL-B5-REFINE | scenario-intelligence | fail | `32b4d0c6f8a2155e2a70856dd3023e72dcc05517` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `32b4d0c6f8a2155e2a70856dd3023e72dcc05517` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
