...
| INTEL-01-POSITIVE | scenario-intelligence | pass | `5c9d866d5bd589ae639229d351c64203f985d3d6` | no | `test-results/intel01-positive/run-metadata.txt` |
| MARVEL-B5-REFINE | scenario-intelligence | fail | `fdd3988c460fea8270b83d837ee14e9d3728f447` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
| MARVEL-B5-BROAD | scenario-intelligence | fail | `a359a83fb822d0008b9f4368d259f18947a139cb` | no | `test-results/marvel-bracket5-broad/run-metadata.txt` |
| SCIONS-SPELLCRAFT-FF-ONLY | scenario-intelligence | pass | `5c9d866d5bd589ae639229d351c64203f985d3d6` | no | `test-results/scions-spellcraft-ff-only/run-metadata.txt` |
| MIDDLE-EARTH-PRECON-REFINE | scenario-intelligence | pass | `5c9d866d5bd589ae639229d351c64203f985d3d6` | no | `test-results/middle-earth-precon-refine/run-metadata.txt` |
| PRECON-GENERALIZATION | scenario-intelligence | pass | `5c9d866d5bd589ae639229d351c64203f985d3d6` | no | `test-results/precon-generalization/run-metadata.txt` |
...
| SQUIRRELED-AWAY-GENERALIZATION | scenario-intelligence | pass | `5c9d866d5bd589ae639229d351c64203f985d3d6` | no | `test-results/precon-generalization-squirrels/run-metadata.txt` |
