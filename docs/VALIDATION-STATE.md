...
|---|---|---|---|---|---|
| PM-STATE-INTEGRITY | engineering+truth | pass | `a45c3387b07c861aee921f3039519b6d4c606b69` | no | `test-results/project-management/integrity.txt` |
| MARVEL-B5-REFINE | scenario-intelligence | pass | `efcffc291fd35a9b5c0177f759f8e8228b702725` | no | `test-results/marvel-bracket5/refine-run-metadata.txt` |
