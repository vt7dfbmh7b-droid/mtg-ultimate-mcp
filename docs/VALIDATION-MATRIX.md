...
|---|---|---|---|---|
| CI / TypeScript / unit tests | Source compiles and deterministic regressions pass | build, types, unit tests | none by itself | last accepted exact source `77a5383...` passed 785/785; current KF-026/KF-027 semantic repair passes TypeScript and 797/797 locally pending exact-head CI |
...
| Squirreled Away precon generalization | unrestricted token precon upgrade under hard budget | legal exact 100; budget; substantive combat-token identity; cumulative and per-swap preservation; token-engine semantic regression | accepted swaps must preserve token multipliers, go-wide payoffs and meaningful finishers, not merely a ratio of broad labels | **REJECTED FALSE GREEN at `51621b4...`**: cut Chatterfang, Squirrel Sovereign, Beastmaster Ascension and End-Raze Forerunners; registered evidence remains fail until KF-027 exact-source revalidation |
