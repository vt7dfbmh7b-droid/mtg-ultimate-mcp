...
| Marvel Bracket-5 live refinement | end-to-end constrained autonomous improvement | legal 100, Marvel exact physical printings, route verification | must actually repair/advance failed B5 gates | **RESTRICTED SCENARIO PASS at `3cfca39...`** in focused and broad lanes; Vanquish the Horde→Vandalblast and Arcane Signet→Ponder repaired average nonland MV 2.71→2.59, added no failed construction gate, and passed explicit cut/strategy evidence; final deck remains Bracket 4 with 0 verified wins, so broad validation is pending |
| expanded Middle-earth live control | exact restricted construction and honest refusal when no supported package advances a failed gate | legal exact 100; HOB/HOC/LTC/LTR/SLD physical printings; passing speed, interaction and tutor gates | no scenario-improvement claim unless a package is accepted and improves the whole deck | **ENGINEERING + CONSTRAINT-TRUTH PASS at `3cfca39...`**; 0 swaps, Bracket 3, average nonland MV 2.41 and 0 verified wins; next restricted control must start from an addressable precon-style weakness before it can test INTEL-02 improvement |
| Food and Fellowship precon live refinement | exact restricted precon upgrade under hard budget and identity constraints | legal exact 100; HOB/HOC/LTC/LTR/SLD physical printings; NZ$35/card and NZ$200 package caps; complete negative route evidence; structural floors | must accept a supported package that repairs or advances an independently evaluated Bracket-4 structure gate without reducing Food/lifegain affinity or meaningful strategy | local high-standard pass: 4 swaps, NZ$28.74, average nonland MV 3.26→3.03, early plays 22→25, interaction 12→13, true protection 0→4, Food/lifegain affinity 232→232, recursion 3→3 and wipes 4→4; exact checked-in-source live evidence pending |
