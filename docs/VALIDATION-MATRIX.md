...
| target-aware candidate-generation tests | failed B5 gates drive candidate lanes before aspirational role deficits | average-nonland-mv lane only proposes positive curve reductions; lower brackets unchanged | candidates can address the evaluator's real blocker | implemented and green at `758c565...`; live Marvel curve repair succeeded |
