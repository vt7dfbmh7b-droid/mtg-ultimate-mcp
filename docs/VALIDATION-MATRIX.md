...
| strategy-preservation / cut-impact tests | autonomous target repair does not silently erase a strongly protected commander strategy | per-swap cut roles and strategy affinity; aggregate package audit; missing evidence and uncompensated meaningful loss fail closed | a safer cut outranks a larger cosmetic curve reduction; strategically matched replacement remains legal | deterministic regression green on the current working lineage; fresh Marvel live revalidation pending |
