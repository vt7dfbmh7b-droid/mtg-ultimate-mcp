...
The follow-up requested-mechanism pairing tests already exist at `1e06aaf`; `3bc7e2b5e5c895705d6813093c712d09e012afc0` corrects the fallback control and passes CI `34377710210`. These commits change only a test, not runtime behavior. Do not describe them as a new intelligence repair or recreate their already-green hand-authored pairing witness. The next proof must reach the actual public planner/precon route with realistic generated OUT/IN summaries, a safer filler and a compatible replacement, exposing where mechanism importance is lost before another generic patch is justified.

Keep the existing focused/full validation, new-source frozen replay, complete-deck review and general-AI comparison requirements. The existing comparison verdicts are analytical, not independently executed alternative 100-card builds. The enabled hourly Chat automation already instructs state reconciliation; its full prompt and schedule remain unchanged, and the old Work schedules remain disabled. Accepted Commander baseline stays `e17b0a1cba659b229fd6f0b6e2df79c5e464a616`; PR #29 and stable/current V0.13 remain unmerged/unpromoted.

## Previous BENCH-01 checkpoint — 34cbc784

The formally validated contextual candidate `34cbc7843fcc936bd153a6516e1762ad2b5091e5` has now completed the required **eight-fixture** frozen replay, run `34330764487`, persisted at `069b700adf9329004791d52e3961aedd60d318b5`. The TypeScript runner was extended through ordinary repository edits; the earlier execution-interface blocker is resolved. Its legacy workflow title/metadata still list five, but the actual structured result contains all eight fixtures. Do not repeat this finished batch.

The superseding durable verdict at `test-results/bench01-manual-verdicts/34cbc7843fcc936bd153a6516e1762ad2b5091e5.md` **rejects baseline acceptance**. Five control decks remain composition-identical to the earlier reviewed control replay. Revenant Recon and Deep Clue Sea show partial utility improvements but retain weak contextual protection/tutor credit and outgoing engine losses; Revenant still has one cheap interaction and misses target 3. Endless Punishment remains unsupported-theme with zero swaps, a separate taxonomy failure.

The next action is production-path reproduction of outgoing-engine/incoming-role-effectiveness failures, including tracing helper/core planner wiring, followed by the smallest generic repair, exact-commit focused/full validation and a new frozen affected/control replay. Do not introduce card-name or fixture exceptions. Whole-deck review and honest general-AI comparison remain mandatory; existing qualitative comparisons do not establish an independently executed alternative-build benchmark. Accepted Commander baseline remains `e17b0a1cba659b229fd6f0b6e2df79c5e464a616`.
