...
- Source `f0c3b9f82dca49f295e44175e517d992e6e5356e` passed the exact-source dependent Squirreled Away, Necron, Food and Fellowship and Middle-earth controls. The focused and broad Marvel controls both executed and persisted with no-supported-improvement and zero swaps. The generic compound operational-component guard now rejects the six historical focused substitutions when a cut's interaction, land/mana, treasure, sacrifice, card-advantage, token or cost-reduction families are not retained like-for-like; the broad lane still exhausts its restricted fast-mana/tutor pool. The prior source `7265531...` six-swap package remains historical/manual-review evidence only. Liliana's NZ$500 benchmark passed legality, budget and all measured construction gates with three verified win-oriented combos; it remains supplementary evidence, not the positive INTEL-01 full-table proof. Runtime CI source `45f4cb9acb082d0bd4bb89310b90e9e63fbeb44d` passed after the timer-race fix.
