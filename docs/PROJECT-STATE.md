...
- Active branch status: **accepted-checkpoint-77a-intel01-positive-route-follow-up-ff32-cumulative-strategy-fuel-and-floor-failures**
...
- Treat PR #32's exact-source Scions & Spellcraft run 33813323027 (source a079090...) and the disposable active-source replay 7a2a80f... as medium/high benchmark failures: local preservation/coarse affinity can pass while Y'shtola trigger-spell density falls 29→27 or 29→21 and board wipes fall 3→2; add generic package-level strategy-fuel and structural-floor non-regression, reproduce from one current executable SHA, and keep the family blocked until it passes
