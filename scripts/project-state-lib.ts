...
export function validateProjectState(state: ProjectState, root = process.cwd()): string[] {
  ...
  if (typeof state.stable.promotionAuthorized !== 'boolean') errors.push('stable.promotionAuthorized must be boolean.');
