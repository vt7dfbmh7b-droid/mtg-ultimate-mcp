...
export function validateProjectState(state: ProjectState, root = process.cwd()): string[] {
  ...
  for (const filename of ['ULTIMATE_MTG_SPEC.md', 'docs/ROADMAP.md', 'docs/DECISIONS.md', 'docs/VALIDATION-MATRIX.md', 'docs/KNOWN-FAILURES.md', 'docs/PROJECT-MANAGEMENT.md']) {
